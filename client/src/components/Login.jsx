...
const Login = ({Switch}) => {
  return (
    ...
    <form id='form' className='relative'>
        <h2 className='absolute heading-top'>Login</h2>
        <button onClick={()=> Switch(0)} id='btn-cross' className="absolute corner btn btn-outline-primary rounded-circle" type="button">
            <h4 id='cross' className="bi">X</h4>
            <span className="visually-hidden">Dismiss</span>
        </button>

        <div data-mdb-input-init className="form-outline mb-4">
            <label className="form-label" htmlFor="form2Example1">Email address</label>
            <input placeholder='Enter Email' type="email" id="form2Example1" className="form-control" />
        </div>
        ...
        <button data-mdb-ripple-init type="button" className="btn btn-primary btn-block mb-4">Login</button>
